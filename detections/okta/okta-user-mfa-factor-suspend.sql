SELECT
  ...
  JSONExtractString(rawLog, 'debugContext', 'debugData', 'factorType') as factor_type,
  JSONExtractString(rawLog, 'debugContext', 'debugData', 'factorId') as factor_id,
  *
FROM
  okta_logs
WHERE
  eventName = 'user.mfa.factor.suspend'
  AND outcome = 'SUCCESS'
